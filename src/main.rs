...
// Inverse of 2 mod p, this parameter must be updated if changing underlying characteristic.
pub const INV_2: Fq = MontFp!("2605322007839614397030347162695477926698574654976912690887795640178045416898560");
...
pub const C4: Fq2 = Fq2::new(INV_2, MontFp!("0"));
